$(document).ready(function(){
    ...
    // .mmain을 눌렀을때
        ...
        // 열기가 끝나면
        // 지금누른그것을 제외한 나머지 .mmain 안에 있는 .musb를 닫기
    ...
    // .main중에 mainnum번째 안에 들어있는 .sub 안에 들어있는 li
        // 의 개수대로 반복.
            // 그것(li) 안에 있는 a태그의 href 속성값과 text를 알아내서
    ...
    // li의 개수만큼 반복
        // #depth2_cont 안쪽에 새로운 a들을 만들기(href랑 text를 넣어서)
    ...
    // #depth1_mark 내용 넣어주기
    // #depth1_cont 안에 들어잇는 a중에 mainnum번째의 글자내용을 알아내서
    // #depth1_mark 안에 내용으로 넣어주기
    
    $("#depth1_mark").text($("#depth1_cont>a").eq(mainnum).text());
    
    // #depth2_mark 내용 넣어주기
    // #depth2_cont 안에 들어잇는 a중에 subnum번째의 글자내용을 알아내서
    // #depth2_mark 안에 내용으로 넣어주기
    ...
    // 페이지 내 모든 table태그에게 다음과 같이 따로따로 이야기하겠다.
        ...
        // 그테이블 아래에 <div class='newtable'><table></table></div>를 만들고
    ...
    // .list-circle 이라는 리스트 안에 있는 li 안에있는
